...
classSelect.addEventListener('change', function () {
    ...
    habilidades[selectedClass].forEach((habilidade, index) => {
        ...
        if (selectedClass === 'alquimista') {
            vidaSpan.innerHTML = '1d6';
            proficienciasSpan.innerHTML = 'Armadura: leve <br>Arma: simples e bombas';
            equipamentoTexto.innerHTML = 'Você começa com uma poção de cura e um conjunto de ferramentas de alquimia e bombas';
        } else if (selectedClass === 'artesao') {
            vidaSpan.innerHTML = '1d6';
            proficienciasSpan.innerHTML = 'Livros de Magia';
            equipamentoTexto.innerHTML = 'Você começa com uma poção de cura e um conjunto de ferramentas de alquimia e bombas';
